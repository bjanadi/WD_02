            ...
            <div>
                <ul className="nav nav-tabs nav-justified">
                    <li className="nav-item">
                        <NavLink to="/studentCourseWeb" className="nav-link" exact activeStyle={{color:'black'}}>COURSEWEB</NavLink>
                    </li>
                    <li className="nav-item">
                        <NavLink to="/approvedCourses" className="nav-link" exact activeStyle={{color:'black'}}>Join A Course</NavLink>
                    </li>
                    <li className="nav-item">
